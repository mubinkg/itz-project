    ...
    return (
        <div className="container mx-auto py-6 px-4">
            ...
            <div className="text-center mb-8">
                <h1 className="text-2xl font-semibold mb-1">সহকারী কমিশনার (ভূমি)</h1>
                <h2 className="text-xl mb-4">শিবগঞ্জ, চাঁপাইনবাবগঞ্জ</h2>
            </div>
                ...
                <Table>
                    <TableHeader>
                        <TableRow>
                            ...
                            <TableHead className="whitespace-nowrap">মালিকের নাম ও ঠিকানা</TableHead>
                    ...
                    <TableBody>
                        <TableRow>
                            ...
                            <TableCell className="whitespace-nowrap bg-red-500 text-white">৩৪৫৪</TableCell>
